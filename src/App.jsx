...
function Preview({sn,sy,sm,phases,onBack}){
  const mw=42,mx=Math.max(14,phases[2].end+2);
        ...
        <div id="print-area" style={{background:"#fff",borderRadius:16,boxShadow:"0 4px 24px rgba(0,0,0,0.08)",overflow:"hidden",padding:"40px 36px"}}>
          ...
          <div style={{background:"#FFFDF5",borderRadius:10,padding:"14px 12px",border:"1px solid #E8E8E0",overflowX:"auto"}}>
            ...
            <div style={{minWidth:480}}>
              <div style={{display:"flex",paddingLeft:80,marginBottom:1}}>
              ...
              <div style={{display:"flex",marginBottom:3,paddingLeft:80}}>
              ...
              {phases.map((ph,pi)=>(
                <div key={pi} style={{marginBottom:1}}>
                  <div style={{display:"flex",alignItems:"center",height:16}}>
                    <div style={{width:80,fontSize:9,fontWeight:700,color:PC[pi],paddingRight:4,textAlign:"right",flexShrink:0}}>{PN[pi]}</div>
                  ...
                  {ph.tasks.map((tk,ti)=>(
                    <div key={ti} style={{display:"flex",alignItems:"center",height:13}}>
                      <div style={{width:80,fontSize:8,color:"#64748b",paddingRight:4,textAlign:"right",flexShrink:0,overflow:"hidden",whiteSpace:"nowrap",textOverflow:"ellipsis"}}>{tk.name}</div>
